...
# cv_analyser_with_rag documentation build
...
from cv_analyser_with_rag import __version__ as release

# -- Project information -----------------------------------------------------

project = "cv_analyser_with_rag"
author = "Kedro"
...
htmlhelp_basename = "cv_analyser_with_ragdoc"
...
latex_documents = [
    (
        master_doc,
        "cv_analyser_with_rag.tex",
        "cv_analyser_with_rag Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cv_analyser_with_rag",
        "Project cv_analyser_with_rag codebase.",
        "Data-Science",
    )
]
